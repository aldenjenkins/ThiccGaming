...
class ThreadedComment(ExportModelOperationsMixin('threadedcomment'), Comment):
    """
...
class Keyword(ExportModelOperationsMixin('keyword'), Slugged):
    """
...
class AssignedKeyword(ExportModelOperationsMixin('assignedkeyword'), Orderable):
    """
